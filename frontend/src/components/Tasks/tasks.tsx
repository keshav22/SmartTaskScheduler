...
export function TasksPageComponent() {
  ...
  const [openEditAddTaskModal, setOpenEditAddTaskModel] = useState(false)
    ...
    <div>
      <div className="flex flex-col gap-[30px] px-[48px] pt-[54px]">
        <div className="flex justify-between items-center">
          <p className="text-3xl font-bold">Active Tasks</p>
          ...
          <ButtonComponent
            ...
            onClick={() => {
              ...
              setAddEditTask({} as Task)
            }}
          >
            <div className="flex items-center px-[12px] gap-1 justify-center">
              <svg
                width="20px"
                height="20px"
                viewBox="0 0 24 24"
        ...
        <div className="py-[13px] border-y-[1px] border-[#DFE2E2]">
          <Input
        ...
        <div className="flex items-center text-[#919797] gap-4">
          ...
          <button className="cursor-pointer" onClick={bulkDelete}>
        ...
        <div className="bg-white p-3 rounded-xl shadow-[0px_8px_16px_#0000000F,0px_0px_0px_#171a1f00]">
          <Table className="text-[#919797]">
            <TableHeader>
              <TableRow>
                <TableHead></TableHead>
                        ...
                        <Checkbox
                          ...
                          onCheckedChange={(checked: boolean) => {
                            if (checked) {
                              ...
                              setCheckedTaskListIds(checkedTaskListIds)
                            } else {
                              const updatedTaskIds: string[] =
                                checkedTaskListIds.filter(
                                  (x: string) => x != task.task_id.toString(),
                                )

                              setCheckedTaskListIds(updatedTaskIds)
                            }
                          }}
                        />
                      </TableCell>
      ...
      <AddEditTaskDialog
        AllTasks={tasks.filter((x) => x.task_id != addEditTask?.task_id)}
